...
export default function StudioScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <TextInput placeholder="Title (try: 'love', 'calm', 'hype')" placeholderTextColor="#6b7a86" value={title} onChangeText={setTitle} style={styles.input} />
      <TextInput placeholder="Short description" placeholderTextColor="#6b7a86" value={desc} onChangeText={setDesc} style={styles.input} />
      <TouchableOpacity style={styles.btn} onPress={handleGenerate}>
        <Text style={{ color: "#001219", fontWeight: "700" }}>{processing ? "Processing..." : "Analyze (Mock AI)"}</Text>
      </TouchableOpacity>
