// ai/LocalAIMock.js
// Simple deterministic mock AI that "detects" mood & generates captions.
// In production replace with real AI calls.
...
function pickMoodFromText(text = "") {
  ...
  // default: pick by simple length/hash
  const idx = (text.length % MOODS.length);
  return MOODS[idx];
}
